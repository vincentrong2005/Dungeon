export const FINAL_FLOOR_NAME = '终极区域';
export const FINAL_AREA_NAME = '终极区域';
...
export const FLOOR_MAP: Record<string, string[]> = {
  ...
  [FINAL_FLOOR_NAME]: [FINAL_AREA_NAME],
};

export const FLOOR_ORDER = ['第一层', '第二层', '第三层', '第四层', '第五层', FINAL_FLOOR_NAME] as const;
