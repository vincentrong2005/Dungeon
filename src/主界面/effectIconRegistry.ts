...
export const EFFECT_FA_ICON_CLASS: Partial<Record<EffectType, string>> = {
  ...
  [ET.INTANGIBLE]: 'fa-brands fa-gitter',
  [ET.TWINS]: 'fa-solid fa-cancer',
  [ET.MEMORY_FOG]: 'fa-brands fa-phabricator',
  [ET.SIGHT_DEPRIVATION]: 'fa-solid fa-eye-low-vision',
  [ET.FATE_OBSERVATION]: 'fa-solid fa-capricorn',
  [ET.SILENCE]: 'fa-solid fa-ban',
  [ET.CONTROLLED]: 'fa-solid fa-face-dizzy',
  [ET.RESONANCE_LOCK]: 'fa-solid fa-code-commit',
  ...
  [ET.PHASE_TRANSITION]: 'fa-brands fa-confluence',
