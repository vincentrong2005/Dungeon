...
const LOCAL_FOLDER_IMAGE_RULES: Record<string, LocalFolderImageRule> = {
  ...
  '地牢/魔物/多萝西': { baseName: '多萝西', end: 15 },
  '地牢/魔物/维罗妮卡': { baseName: '维罗妮卡', end: 15 },
  '地牢/魔物/伊丽莎白': { baseName: '伊丽莎白', end: 12 },
  '地牢/魔物/尤斯蒂娅': { baseName: '尤斯蒂娅', end: 1 },
  '地牢/魔物/克拉肯': { baseName: '克拉肯', end: 1 },
  '地牢/魔物/布偶': { baseName: '布偶', end: 1 },
  '地牢/魔物/赛琳娜': { baseName: '赛琳娜', end: 1 },
  '地牢/魔物/米拉': { baseName: '米拉', end: 1 },
  '地牢/魔物/梦魔双子': { baseName: '梦魔双子', end: 1 },
  '地牢/魔物/贝希摩斯': { baseName: '贝希摩斯', end: 1 },
  '地牢/魔物/佩恩': { baseName: '佩恩', end: 1 },
  '地牢/魔物/西格尔': { baseName: '西格尔', end: 1 },
  '地牢/魔物/摩尔': { baseName: '摩尔', end: 1 },
  '地牢/魔物/利维坦': { baseName: '利维坦', end: 1 },
  '地牢/魔物/奥赛罗': { baseName: '奥赛罗', end: 1 },
  '地牢/魔物/盖亚': { baseName: '盖亚', end: 1 },
};
